          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-between border-r border-white/10">
              <div>
                ...
                <h1 className="text-3xl md:text-4xl font-open-sans-custom text-white mb-4">Welcome to DECIBEL</h1>
                <p className="text-[#C0C0C0] font-open-sans-custom leading-relaxed">
                  Transform your audio data into actionable intelligence. Join thousands of teams already using DECIBEL.
                </p>
              </div>

              <div className="mt-12 p-6 rounded-xl bg-white/5 border border-white/10">
                <p className="text-[#C0C0C0] font-serif italic text-lg mb-4">
                  "DECIBEL has revolutionized how we analyze customer calls. The insights we get are invaluable."
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-white/20" />
                  <div>
                    <p className="text-white font-open-sans-custom text-sm">Sarah Chen</p>
                    <p className="text-[#C0C0C0] text-xs font-open-sans-custom">Head of Analytics, TechCorp</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 md:p-12 relative">
              ...
              <h2 className="text-2xl font-open-sans-custom text-white mb-2">Create your account</h2>
              <p className="text-[#C0C0C0] font-open-sans-custom mb-8">Get started with DECIBEL today</p>
              ...
              <form className="space-y-6">
                ...
                <button
                  type="button"
                  className="w-full py-3 rounded-lg bg-white text-black font-open-sans-custom hover:bg-gray-100 transition-colors"
                >
                  Create Account
                </button>
